...
#         coordinates.add((robot.px, robot.py))
#     if second == 7082:
#         print(f"{second+1} second after:\n")
...
for _ in range(10000):
    ...
    safety_scores.append(quadrants[0]*quadrants[1]*quadrants[2]*quadrants[3])

print(safety_scores.index(min(safety_scores))+1)