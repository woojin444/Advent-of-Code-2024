...
class Game:
    ...
    def find_optimal_presses(self):
        ...
        while required_A <= 10000000000000 and required_B <= 10000000000000:
...
with open("inputs/d13p12.txt", "r") as input_file:
    while True:
        ...
        game = Game(ax=int(re.search(button_pattern_X, lines[0]).group(1)),\
                    ...
                    px=int(re.search(prize_pattern_X, lines[2]).group(1))+10000000000000,\
                    py=int(re.search(prize_pattern_Y, lines[2]).group(1))+10000000000000)
        games.append(game)
